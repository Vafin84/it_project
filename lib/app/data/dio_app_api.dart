...
import 'package:it_project/app/data/auth_interceptor.dart';
...
class DioAppApi implements AppApi {
  ...
  @override
  Future<Response> singIn({required String username, required String password}) {
    try {
      return dio.post(
        "/auth/token",
  ...
  @override
  Future<Response> singUp({required String username, required String password, required String email}) {
    try {
      return dio.put(
        "/auth/token",

...
import '../../feature/auth/domian/auth_repository.dart' as _i6;
import '../../feature/auth/domian/auth_state/auth_cubit.dart' as _i8;
...
_i1.GetIt $initGetIt(
  ...
  gh.factory<_i6.AuthRepositoty>(
      () => _i7.NetworkAuthRepository(get<_i5.DioContainer>()));
  gh.singleton<_i8.AuthCubit>(_i8.AuthCubit(get<_i6.AuthRepositoty>()));
  return get;
}
